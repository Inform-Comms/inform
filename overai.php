...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
        ...
        if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
             ...
             '{
          "result": {
          "introSpeakOut": "18:20 The status for reference '.$reference_number.' is `'.$row["status"].'` You can come back here later to lookup the status of your issue using this number."
          }
        }';
        }
